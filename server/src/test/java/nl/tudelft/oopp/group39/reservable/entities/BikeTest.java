...
class BikeTest extends AbstractTest {
    ...
    @Test
    void testEquals() {
        Bike bike1 = new Bike(null, BikeType.CITY, 5.6, null, null);
        Bike bike2 = new Bike(null, BikeType.CITY, 5.6, null, null);
    ...
    void testEqualsNotInstanceOf() {
        Bike bike = new Bike(null, BikeType.CITY, 5.6, null, null);
