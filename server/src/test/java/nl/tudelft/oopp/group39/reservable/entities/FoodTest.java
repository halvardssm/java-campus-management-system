...
class FoodTest extends AbstractTest {
    ...
    @Test
    void testEquals() {
        Food food1 = new Food(null, "Name", "Description", 5.6, null, null);
        Food food2 = new Food(null, "Name", "Description", 5.6, null, null);
    ...
    void testEqualsNotInstanceOf() {
        Food food = new Food(null, "Name", "Description", 5.6, null, null);
