...
class ReservationAmountTest extends AbstractTest {
    ...
    @Test
    void testEquals() {
        ReservationAmount reservationAmount1 = new ReservationAmount(null, 1, null, null);
        ReservationAmount reservationAmount2 = new ReservationAmount(null, 1, null, null);
    ...
    @Test
    void testEqualsSame() {
        ReservationAmount reservationAmount = new ReservationAmount(null, 1, null, null);
