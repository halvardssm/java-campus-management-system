package nl.tudelft.oopp.group39.roomFacility.RoomFacilityService;

import nl.tudelft.oopp.group39.roomFacility.Entities.RoomFacility;
import nl.tudelft.oopp.group39.roomFacility.Exceptions.RoomFacilityExistsException;
...
public class RoomFacilityService {
    ...
    public RoomFacility deleteRoomFacility(int id) throws RoomFacilityNotFoundException {
        try {
            RoomFacility rf = readRoomFacility(id);
            roomFacilityRepository.delete(readRoomFacility(id));
            return rf;
        }
        catch (RoomFacilityNotFoundException e) {
